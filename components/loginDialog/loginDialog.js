                ...
                <el-dialog width="16.95rem" custom-class='login-dialog' :visible.sync="visible" :show-close=true>
                    <div class="login-left">
                        ...
                        <div class="login-form">
                            ...
                            <div class="form-main">
                                <div class="form-item">
                                    <el-input v-if="isEmailOrPhone" v-model="formData.email" placeholder="请输入电子邮箱"></el-input>
                                    <el-input v-else class="input-with-select select-input" v-model="formData.phone" placeholder="请输入手机号">
                                ...
                                <div v-else class="form-item code-item">
                                    <!-- 邮箱验证码 -->
                                    <el-input v-if="isEmailOrPhone" v-model="formData.emailCode" placeholder="请输入邮箱验证码">
                                    </el-input>
                                    ...
                                    <!-- 手机验证码 -->
                                    <el-input v-if="!isEmailOrPhone" v-model="formData.phoneCode" placeholder="请输入手机验证码">
                                    </el-input>
                                ...
                                <div class="form-item read-item">
                                    ...
                                    阅读并同意<a @click="toService">《服务协议》</a>和<a @click="toPrivacy">《隐私协议》</a>
                                    </el-checkbox>
                                </div>
                                ...
                                <div class="form-item" v-show="commonData.login_phone_verify == 1">
                                    <el-button v-if="isPassOrCode" :disabled="commonData.login_phone_verify == 0" @click="isPassOrCode = false;isEmailOrPhone = false" class="type-btn">验证码登录
                                    </el-button>
                    ...
                    <div class="login-right">
                        <img src="./img/common/login_back.png" class="login-back-img">
                    </div>
                </el-dialog>
            </div>
            ...
            if (isPass) {
                ...
                logIn(params).then(res => {
                    if (res.data.status === 200) {
                        ...
                        localStorage.setItem("isMarketLogin", "1")
                        location.reload();
                    }
                }).catch(err => {
